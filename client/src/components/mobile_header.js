...
const header = {
    ...
    oncreate(vnode) {
        ...
        axios.request(optionsBrands).then(function (response) {
    ...
    view(vnode) {
        ...
        return [
            m("a", {"href":"index.html"}, 
              m("img", {"class":"max-h-30px","alt":"Logo","src":brandLogo ? brandLogo : "assets/media/exported-wellwash-new.png"})
            ), 
            m("div", {"class":"d-flex align-items-center"}, 
              m("div", {"class":"d-flex align-items-center"},
                [
                  m("a", {"class":"btn p-0 rounded-0 ml-4","href":"/q-new"}, 
                    m("span", {"class":"svg-icon svg-icon-xxl"}, 
                      m("i", {"class":"fa fa-plus","aria-hidden":"true"})
                    )
                  ),
                  m("a", {"class":"btn p-0 rounded-0 ml-4","href":"j"}, 
                    m("span", {"class":"svg-icon svg-icon-xxl"}, 
                      m("i", {"class":"fa fa-bath","aria-hidden":"true"})
                    )
                  ),
                  m("a", {"class":"btn p-0 rounded-0 ml-4","href":"/dash"}, 
                    m("span", {"class":"svg-icon svg-icon-xxl"}, 
                      m("i", {"class":"fa fa-bar-chart","aria-hidden":"true"})
                    )
                  ),
                  ...
                  m("button", {"class":"btn rounded-0 p-0 ml-2","id":"kt_header_mobile_topbar_toggle"}, 
                    m("i", {"class":"fa fa-filter","aria-hidden":"true"})
                  )
                ]
              )
            )
